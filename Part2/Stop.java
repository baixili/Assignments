...
public class Stop implements Comparable<Stop> {
    ...
    public void setComponentID(int num){
    ...
    public Collection<Edge> getInEdges(){ return Collections.unmodifiableCollection(inEdges);}
    ...
    public void addOutEdge(Edge edge){ this.outEdges.add(edge);}
